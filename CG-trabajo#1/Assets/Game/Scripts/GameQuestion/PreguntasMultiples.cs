...
public class PreguntasMultiples
{
    ...
    public PreguntasMultiples(string question, string option1, string option2, string option3, string option4, string answer, string versiculo, string dificultad)
    {
